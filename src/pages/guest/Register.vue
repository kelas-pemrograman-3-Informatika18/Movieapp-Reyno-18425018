<template>
  <q-layout>
    <q-page-container>
      ...
      <q-page padding class="bg-green-grey-1">
        <div class="row">
              ...
              >
                ...
                <q-input
                 ...
                 <div class="q-gutter-md">
                   <q-btn label="Register" type="submit" unelevated color="green" />
                   <q-btn label="Login" :to="{ name: 'loginPage' }" unelevated color="green" flat />
                 </div>
              </q-form>
            </q-card-section>
          </q-card>
